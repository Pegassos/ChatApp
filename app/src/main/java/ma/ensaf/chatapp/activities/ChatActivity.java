...
import ma.ensaf.chatapp.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void checkForConverrsionRemotely(String senderId, String receiverId) {
        db.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
